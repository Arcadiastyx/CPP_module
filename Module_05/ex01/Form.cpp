...
/*   Updated: 2024/01/30 00:42:54 by inaranjo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#include "Form.hpp"
 ...
 Form::Form( const std::string& name, int gradeToSign, int gradeToExc ) : _name(name), _gradeToSign(gradeToSign), _gradeToExc(gradeToExc)
 {
    if ( gradeToSign < 1 )
